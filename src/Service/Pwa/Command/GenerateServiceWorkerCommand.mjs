...
export class GenerateServiceWorkerCommand {
    ...
    async generateServiceWorker(web_root, application_cache_file, service_worker_file) {
        ...
        await writeFile(application_cache_file, (await readFile(application_cache_file, "utf8")).replaceAll("%APPLICATION-CACHE-VERSION%", application_cache_version).replaceAll("[/*%APPLICATION-CACHE-FILES%*/]", JSON.stringify(application_cache_files)), "utf8");
